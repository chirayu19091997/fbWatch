...
const Content = (props) => {
  ...
  useEffect(() => {
    if (search !== "") {
      axios
        .get(
          `https://api.themoviedb.org/3/search/movie?api_key=ee4b225859a0a74d406a1d2c2f2643b4&query=${search}`
        )
        .then(async (res) => {
          setloading(true);
      ...
      axios
        .get(
          `https://api.themoviedb.org/3/trending/all/week?api_key=ee4b225859a0a74d406a1d2c2f2643b4`
        )
        .then((res) => {
