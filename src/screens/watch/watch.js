  ...
  return (
    <div>
      <br />
        ...
        <Image style={{ float: 'left',height:'400px', width: '250px', margin:'10px 35px 10px 10px'}} src={'https://image.tmdb.org/t/p/w500'+tiles.poster_path}/>
        <h1 style={{ fontSize:'40px', color:'green'}}>{tiles.title}</h1>
        <Button content={tiles.vote_average} icon='heart' labelPosition='right' color='red' inverted/>
